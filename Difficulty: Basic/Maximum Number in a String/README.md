<h2><a href="https://www.geeksforgeeks.org/problems/extract-maximum2943/1">Maximum Number in a String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an alphanumeric string <strong>s</strong> consisting of lowercase letters (a–z), uppercase letters (A–Z), and digits (0–9).</span></p>
