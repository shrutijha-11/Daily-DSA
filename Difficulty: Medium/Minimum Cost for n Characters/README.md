<h2><a href="https://www.geeksforgeeks.org/problems/minimum-time1238/1?_gl=1*wu0si8*_up*MQ..&gclid=CjwKCAjwqc_UBhBKEiwAWbl25lDq3pOdc7-ONEN4eE7qSQvtoUPIxjGs3FF16h6fDAUlubbvQNhZTRoClmIQAvD_BwE&gbraid=0AAAAAC9yBkCwuM_4MuysoXDBMuBf9QAmC">Minimum Cost for n Characters</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given four integers <strong>n</strong>, <strong>i</strong>, <strong>d</strong>, and <strong>c</strong>, where:</span></p>
<ul>
