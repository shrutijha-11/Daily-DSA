<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-products5049/1?_gl=1*iw8pjq*_up*MQ..&gclid=CjwKCAjwqc_UBhBKEiwAWbl25lDq3pOdc7-ONEN4eE7qSQvtoUPIxjGs3FF16h6fDAUlubbvQNhZTRoClmIQAvD_BwE&gbraid=0AAAAAC9yBkCwuM_4MuysoXDBMuBf9QAmC">Sum of Pairwise ANDs</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of integers, calculate the sum of bitwise AND for all pairs of elements such that the first index is less than the second index.</span></p>
