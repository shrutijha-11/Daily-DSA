<h2><a href="https://www.geeksforgeeks.org/problems/secret-cipher--141631/1?_gl=1*cf15cm*_up*MQ..&gclid=Cj0KCQjw4orUBhCjARIsAIbF3qxN3upnF62NzmP9ac846-c8rQM5sunpl6Lem_WpNKMXMebxM0KDIBgaArwpEALw_wcB&gbraid=0AAAAAC9yBkB7eBkKjNCT-Sdbkpr4nOSCg">Secret Cipher</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p class="PDq2pG_selectionAnchorContainer" data-start="23" data-end="177"><span style="font-size: 14pt;">Geek wants to send a secret message to his friend Keeg. Instead of sending the original message directly, he encrypts it by inserting the character '*'.</span></p>
