<h2><a href="https://www.geeksforgeeks.org/problems/geek-in-a-maze--170637/1?_gl=1*12fjvkp*_up*MQ..&gclid=Cj0KCQjw4orUBhCjARIsAIbF3qxN3upnF62NzmP9ac846-c8rQM5sunpl6Lem_WpNKMXMebxM0KDIBgaArwpEALw_wcB&gbraid=0AAAAAC9yBkB7eBkKjNCT-Sdbkpr4nOSCg">Geek in a Maze</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p data-start="571" data-end="632"><span style="font-size: 14pt;">Given a maze <strong>mat[][]</strong> of size<strong> n × m</strong>, where each cell is either:</span></p>
<ul>
